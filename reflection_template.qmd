...
Throughout the course, I revised my thinking by making sure to format my code heavily. Before, I would not put spaces on either side of my equal sign and I would often have many arguments for a function all in one line. However, now in almost all of my code it is formatted way better. I also did revisions for almost every assignment.
...
Throughout the course I have been extending my thinking by seeing how I can concisely meet all of the requirements provided and make it look good. For example, in my yaml I apply the cyborg theme so that my HTML looks cool and in challenge 4 code chunk 2 (a code chunk that I used pretty frequently) I changed the color of the graph I made to colors that I like.
